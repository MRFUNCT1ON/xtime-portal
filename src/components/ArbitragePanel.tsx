        ...
        >
          <Card className="glass-card border-border/50">
            ...
            <CardContent className="space-y-6">
              ...
              <Button
                onClick={() => bestMove?.functionId && handleExecute(bestMove.functionId)}
                disabled={isButtonDisabled || !plsAmount || !bestMove?.functionId || bestMove.functionId === 'none'}
                className="w-full py-6 font-display text-lg bg-gradient-to-r from-primary to-accent hover:opacity-90 text-primary-foreground"
              >
